...
public class DBConfig {
    ...
    @Primary
    @DependsOn({"dataSource1", "configuration1"})
    public SqlSessionFactoryBean getSqlSessionFactory(@Qualifier("dataSource1") DataSource dataSource,
                                                      @Qualifier("configuration1") org.apache.ibatis.session.Configuration configuration) {
    ...
    @Bean("tm1")
    public PlatformTransactionManager getDataSourceTransactionManager(@Qualifier("dataSource1") DataSource dataSource) {
